...
class CommentDAO extends DAO 
{
     ...
     *
     * @return \api\Domain\Comment|throws an exception if no matching comment is found
     */
     ...
     *
     * @param \api\Domain\Comment $comment The comment to save
     */
